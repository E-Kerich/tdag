...
const Shop = () => {
  ...
  const categories = [
    ...
    { value: "business-systems", label: "Business Systems", icon: ShoppingBag },
    { value: "digital-literacy", label: "Digital Literacy", icon: Shield },
    { value: "templates", label: "Templates", icon: Tag },
    { value: "ebooks", label: "E-books", icon: Clock }
  ];
